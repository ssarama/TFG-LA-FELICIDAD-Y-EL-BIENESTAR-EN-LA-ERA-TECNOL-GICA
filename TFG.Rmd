...
kable(t(info_Felicidad)[-1, ], col.names = info_Felicidad$País, caption = "Resumen modelos Felicidad")
```
...
kable(t(info_Satisfacción)[-1, ], col.names = info_Satisfacción$País, caption = "Resumen modelos Satisfacción")
```
...
kable(t(info_Sanidad)[-1, ], col.names = info_Sanidad$País, caption = "Resumen modelos Sanidad")
```
...
kable(t(info_Comodidad)[-1, ], col.names = info_Comodidad$País, caption = "Resumen modelos Comodidad")
```
...
kable(t(info_Oportunidades)[-1, ], col.names = info_Oportunidades$País, caption = "Resumen modelos Oportunidades")
```
...
kable(t(info_Progreso)[-1, ], col.names = info_Progreso$País, caption = "Resumen modelos Progreso")
```
